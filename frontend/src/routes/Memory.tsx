...
import { PageToolbar, PageToolbarSpacer } from '../components/PageToolbar';
      ...
      <PageToolbar>
        <label className="wl-memory__field">
          ...
          <select
            ...
            value={statusFilter}
            onChange={(e) => onStatusFilter(e.target.value as MemoryStatusFilter)}
          >
        ...
        {activeScope === 'book' && (
          <label className="wl-memory__field">
            ...
            <select
              ...
              onChange={(e) => onSelectPortfolio(e.target.value === '' ? null : Number(e.target.value))}
            >
